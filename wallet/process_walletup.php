...
if($otp=="123456")
{
    ...
    mysqli_query($con,"update tbl_wallet set wallet_bal='".$_SESSION['wallet_bal']."' where user_id='".$_SESSION['user']."'");
...
<script>
    setTimeout(function(){ window.location="my_wallet.php"; }, 5000);
</script>