...
<div class="content">
	<div class="wrap">
      ...
      <div class="form-group has-feedback">
        <input name="dob" type="date" class="form-control" required="required" placeholder="Date of birth" />
        
        <span class="glyphicon glyphicon-date form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input name="address" type="text" class="form-control" required="required" placeholder="Address" />
        
        <span class="glyphicon glyphicon-date form-control-feedback"></span>
      </div>
            <div class="form-group has-feedback">
        <input name="id_proof" type="file" class="form-control" required="required" placeholder="Address" />
