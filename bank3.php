...
<body>
              ...
              while($m=mysqli_fetch_array($qry2))
                   {
                    ?>
                                ...
                                <h4 class="h-text">Wallet Bal: <?php echo $m['wallet_bal']?></h4>
 ...
 <?php
    ...
    extract($_POST);
    include('config.php');
    $_SESSION['wallet_bal']=$m['wallet_bal']+$wallet_bal;
...
<div id="mainContainer" class="row large-centered">
  ...
  <dl class="mercDetails">
    ...
    <dt>Transaction Amount</dt> 	<dd>INR <?php echo  $_POST['wallet_bal'];?></dd>
    <dt>Debit Card</dt> 		<dd><?php echo  $number;?></%></dd>
  </dl>
  <hr class="divider">
  
  
<form name="form1" id="form1" method="post" action="process_walletup.php">
