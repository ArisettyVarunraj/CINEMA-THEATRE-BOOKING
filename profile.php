...
<div class="content">
	<div class="wrap">
		<div class="content-top">
				...
				?>
				<?php
				$bk1=mysqli_query($con,"select * from tbl_bookmark where user_id='".$_SESSION['user']."'");
				if(mysqli_num_rows($bk1))
				{
					?>
				<table class="table table-bordered">
						<thead>
						...
						<tbody>
						<?php
						while($bkg1=mysqli_fetch_array($bk1))
						{
							
							$s1=mysqli_query($con,"select * from tbl_movie where movie_id='".$bkg1['movie_id']."'");
							$srn1=mysqli_fetch_array($s1);
							
							?>
							<tr>
								
								<td>
									<a href="about.php?id=<?php echo $bkg1['movie_id'];?>"><?php echo $srn1['movie_name'];?></a>
								</td>
								<td>
									<?php echo $srn1['release_date'];?>
								</td>
								
								<td>
									
									
									<a href="cancelbookmark.php?id=<?php echo $bkg1['id'];?>">Cancel</a>
