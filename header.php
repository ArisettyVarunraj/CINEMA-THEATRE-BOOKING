...
<div class="header">
	<div class="header-top">
        ...
        $user=mysqli_fetch_array($us);?><a href="profile.php"><?php echo $user['name'];?></a><a href="logout.php">Logout</a><li><a href="donor">Manage Account</a></li><li><a href="my_wallet.php">My Wallet</a></li><?php }else{?><a href="login.php">Login</a><?php }?></li>
